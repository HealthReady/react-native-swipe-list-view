		...
		if (!this.props.renderHiddenRow) {
			return React.cloneElement(
				Component,
				{
					...
					disableLeftSwipe: Component.props.disableLeftSwipe || this.props.disableLeftSwipe,
                    			disableRightSwipe: Component.props.disableRightSwipe || this.props.disableRightSwipe,
